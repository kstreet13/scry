...
```{r fig.width=6, fig.height=4}
set.seed(101)
sce2<-GLMPCA(sce2,assay="counts",2)
...
For more details, check out these in-depth vignettes, which also address how
to adjust for batch effects:

* **Feature Selection with Deviance**
* **Dimension Reduction with GLM-PCA and Null Residuals Approximation**
